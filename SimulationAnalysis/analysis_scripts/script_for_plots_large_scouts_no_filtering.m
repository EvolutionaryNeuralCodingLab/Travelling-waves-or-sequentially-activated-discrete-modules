...
figs_dir = 'large_scouts_multiple_bumps/';
...
wave_metrics = load(wave_metrics_matrix_path );
...
close all
save_path = '/media/sil2/Data/Yuval O/Rotem Simulations/figures_for_paper/large_scouts_multile_bumps/En9_no_filtering/';
...
X_start_end = [1,length(wave_metrics_matrix.delta_Xs)];
img_range = [0.80,1];
f = plot_phase_space(wave_metrics.PLDCs,wave_metrics.delta_Ts, wave_metrics.delta_Xs, T_start_end,X_start_end,0,img_range,ax);
hCbar = colorbar;
...
set(gcf,'PaperPositionMode','auto');print PLDC -dpdf -painters;
...
set(gcf,'PaperPositionMode','auto');print spatial_lag_unfiltered -dpdf -painters;
...
set(f2,'PaperPositionMode','auto');print electrode_signal_unfiltered -dpdf -painters;
...
set(gcf,'PaperPositionMode','auto');print scout_signal_unfiltered -dpdf -painters;
