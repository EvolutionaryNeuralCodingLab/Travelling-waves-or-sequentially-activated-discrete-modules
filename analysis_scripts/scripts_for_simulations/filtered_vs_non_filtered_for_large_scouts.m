...
plot(t,electrode_set_unfiltered.electrode_signals(channels_for_signal,:),'LineWidth',line_width)
hold on
plot(t,electrode_set_filtered.electrode_signals(channels_for_signal,:),'LineWidth',line_width)
