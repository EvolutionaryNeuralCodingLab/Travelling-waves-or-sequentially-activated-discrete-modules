...
% Large scouts PLDC:
load('final_mats_for_figures/PLDC_from_simulation_table_large_scouts.mat','delta_Ts','PLDC','plotting_config','scouts_dist_per_std')

% % Small scouts PLDC:
% load('final_mats_for_figures/PLDC_from_simulation_table_small_scouts.mat','delta_Ts','PLDC','plotting_config','scouts_dist_per_std')

% % Large scouts filteres
% load('final_mats_for_figures/PLDC_from_simulation_table_large_scouts_filtered.mat','delta_Ts','PLDC','plotting_config','scouts_dist_per_std')
